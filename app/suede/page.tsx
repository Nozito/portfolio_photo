...
export default function Suede() {
  ...
  const photos = [
    "/img/Stockholm-04.jpg",   // 0 - Grande (2x2)
    "/img/Stockholm-84.jpg",   // 1 - Verticale
    "/img/Stockholm-53.jpg",   // 2 - Verticale
    "/img/Stockholm-28.jpg",   // 3 - Normale
    "/img/Stockholm-82.jpg",   // 4 - Normale
    "/img/Malmo-2.jpg",        // 5 - Grande (2x2)
    "/img/Malmo-1.jpg",        // 6 - Verticale
    "/img/Malmo-3.jpg",        // 7 - Verticale
  ];
  ...
  const getGridClass = (idx: number) => {
    ...
    if (idx === 1 || idx === 2 || idx === 6 || idx === 7) return 'md:row-span-2'; // Verticales
    return ''; // Normales
  };
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <Head>
        <title>Suède - Noah Dekeyzer</title>
        <meta name="description" content="Photos de voyage en Suède" />
      </Head>
      ...
      >
        ...
        >
          ...
          >
            ...
            Entre architecture nordique et nature scandinave.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-bold text-white mb-1">2</p>
            <p className="text-sm text-gray-500 uppercase tracking-wider">Villes</p>
          </div>
        </motion.div>
      </motion.header>
      ...
      <AnimatePresence>
        {selectedPhoto && (
          ...
          >
            ...
            >
              <p className="text-gray-400 text-sm mb-1">Suède</p>
