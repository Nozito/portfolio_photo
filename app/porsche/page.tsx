...
export default function Porsche() {
  ...
  const photos = [
    ...
    "/img/GT3RSint.jpg",     // 4 - STAR - Grande (2x2)
    "/img/GT3RSpl.jpg",      // 5 - Verticale
    "/img/Jantes.jpg",       // 6 - Étirée pour remplir (col-span-2)
    "/img/Watchs.jpg",       // 7 - Étirée pour remplir (col-span-2)
  ];

  const getGridClass = (idx: number) => {
    if (idx === 0) return 'md:col-span-2 md:row-span-2';
    if (idx === 4) return 'md:col-span-2 md:row-span-2';
    if (idx === 6 || idx === 7) return 'md:col-span-2 md:row-span-2';
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <Head>
        <title>Porsche - Noah Dekeyzer</title>
        <meta name="description" content="Photos de Porsche" />
      </Head>
      ...
      >
        ...
        >
          ...
          >
            L'excellence allemande capturée dans chaque détail.
            <br className="hidden md:block" />
            Performance, design et héritage légendaire.
          </motion.p>
        </motion.div>
      ...
      {/* Galerie avec 2 dernières photos étirées */}
            ...
            >
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  {/* Numéro - S'affiche uniquement au survol */}
      ...
      <AnimatePresence>
        {selectedPhoto && (
          ...
          >
            ...
            >
              <p className="text-gray-400 text-sm mb-1">Porsche</p>
